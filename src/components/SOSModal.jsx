...
import { X, PhoneCall, AlertTriangle, UserCheck, CheckCircle2 } from "../GoogleIcons";
        ...
        {requested ? (
          <div style={{ textAlign: "center", padding: "1.5rem 0" }}>
            ...
            <div style={{ background: "rgba(15, 23, 42, 0.8)", padding: "0.85rem", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.08)", fontSize: "0.8rem", color: "#94a3b8", marginBottom: "1.25rem" }}>
              Current destination: <strong>{patient.nextStep?.location}</strong> · Token: <strong>{patient.token}</strong>
            </div>
            <button
