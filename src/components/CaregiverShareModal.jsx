...
import { X, Share2, Copy, Check, QrCode, ShieldCheck } from "../GoogleIcons";
...
export default function CaregiverShareModal({ patient, lang, onClose }) {
  ...
  const shareLink = typeof window !== "undefined" 
    ? `${window.location.origin}/caregiver-view?token=${patient.token}&patient=${patient.patientId}` 
    : `https://medcode.hospital/caregiver?token=${patient.token}`;
